...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'ProfessorCRS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'ProfessorCRS;255788925545',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? '2024;ProfessorCRS;' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'ProfessorCRS' : process.env.STICKER_DATA,
