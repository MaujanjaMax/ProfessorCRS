...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME || 'Prof CRS',
    ...
    BOT_INFO: process.env.BOT_INFO || 'CYRUSI DIGITAL PREMIUM',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'Cyrusi Digital' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'cyrusi Digital' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '255785078502',
       DEBUG: DEBUG
};
